...
// The `ThreadExample` class contains the `main` method where instances of both thread types are created and started.
// The `run` method in each class defines the behavior of the thread when it is started.
// The `main` method creates instances of both thread types and starts them, demonstrating how to run multiple threads concurrently in Java.
// The `main` method creates instances of both thread types and starts them, demonstrating how to run multiple threads concurrently in Java.
// The `run` method in each class defines the behavior of the thread when it is started.
// The `main` method creates instances of both thread types and starts them, demonstrating how to